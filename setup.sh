...
export CR_DATA_VOLUME_NAME=${CR_DATA_VOLUME_NAME:-huly_cr_data}
export CR_CERTS_VOLUME_NAME=${CR_CERTS_VOLUME_NAME:-huly_cr_certs}
export REDPANDA_VOLUME_NAME=${REDPANDA_VOLUME_NAME:-huly_redpanda}
export TELEMETRY_VOLUME_NAME=${TELEMETRY_VOLUME_NAME:-huly_telemetry}
